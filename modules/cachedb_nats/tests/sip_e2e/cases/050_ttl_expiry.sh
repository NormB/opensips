# 050 — native per-key TTL expiry, the case this suite was
...
# (reaper-only expiry; default scan interval 30 s).
...
# reaper-only: reclaim lands on the first reaper pass after
