...
/* --- index internals shared across the FTS TUs -------------------- */

#include "../../locking.h"

/* The process-global SHM search index; the query walk reads it directly
