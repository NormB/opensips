...
#
# Work-item labels ([P3.2], P2.3), review ids ([REV-15], [HREV-1], [TREV-2]),
...
# the capacity runbook / design package) and "owner decision" notes mean
